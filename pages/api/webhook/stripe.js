...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (event.type === "checkout.session.completed") {
      ...
      console.log("WE ARE IN HERE!!! MADE IT TO THE WEBBOOK BABY")
      console.log("the session is")
      console.log(session)

      console.log("Session info:", { customerId, priceId, userId });

      const user = userId ? await User.findById(userId) : await User.findOne({ email: event.data.object.customer_email });
